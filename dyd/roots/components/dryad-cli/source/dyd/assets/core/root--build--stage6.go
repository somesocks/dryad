...
var rootBuild_stage6 func(ctx *task.ExecutionContext, req rootBuild_stage6_request) (error, *SafeHeapStemReference) = func(ctx *task.ExecutionContext, req rootBuild_stage6_request) (error, *SafeHeapStemReference) {
	zlog.Trace().
