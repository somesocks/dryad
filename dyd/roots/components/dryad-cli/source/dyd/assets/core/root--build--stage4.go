...
var rootBuild_stage4 func(ctx *task.ExecutionContext, req rootBuild_stage4_request) (error, *SafeHeapStemReference) = func(ctx *task.ExecutionContext, req rootBuild_stage4_request) (error, *SafeHeapStemReference) {
