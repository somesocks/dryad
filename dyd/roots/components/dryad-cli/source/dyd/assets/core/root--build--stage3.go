...
var rootBuild_stage3 func(ctx *task.ExecutionContext, req rootBuild_stage3_request) (error, string) = func(ctx *task.ExecutionContext, req rootBuild_stage3_request) (error, string) {
