...
var STEM_WALK_MATCH_INCLUDE, _ = regexp.Compile(`^((dyd/path/.*)|(dyd/assets/.*)|(dyd/readme)|(dyd/README)|(dyd/fingerprint)|(dyd/secrets-fingerprint)|(dyd/main)|(dyd/stems/.*/dyd/fingerprint)|(dyd/stems/.*/dyd/traits/.*)|(dyd/traits/.*))$`)
